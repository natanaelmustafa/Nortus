...
TEZTextureProperty = class(TClassProperty)
 ...
 TplGifFileNamePropertyEditor = class(TFileNamePropertyEditor)
  public
...
// RegisterComponentEditor(TplPageControl,TplPageControlEditor);
 ...
 RegisterPropertyEditor(TypeInfo(String), TplGifAnimator,'FileName', TplGifFileNamePropertyEditor);
...
//=============== TplGifFileNamePropertyEditor ===============================
function TplGifFileNamePropertyEditor.GetFilter: String;
begin
  Result := 'GIF|*.gif';
end;

function TplGifFileNamePropertyEditor.GetInitialDirectory: string;
begin
