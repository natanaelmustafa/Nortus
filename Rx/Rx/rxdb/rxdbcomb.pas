...
{ TCustomDBComboBox }
  ...
  TRxCustomDBComboBox = class(TCustomComboBox)
  private
...
{ TRxDBComboBox }
  ...
  TRxDBComboBox = class(TRxCustomDBComboBox)
  private
    FValues: TStrings;
...
constructor TRxCustomDBComboBox.Create(AOwner: TComponent);
begin
...
destructor TRxCustomDBComboBox.Destroy;
begin
...
procedure TRxCustomDBComboBox.Loaded;
begin
  inherited Loaded;
  if (csDesigning in ComponentState) then DataChange(Self);
end;

procedure TRxCustomDBComboBox.Notification(AComponent: TComponent;
...
procedure TRxCustomDBComboBox.CreateWnd;
begin
  inherited CreateWnd;
  SetEditReadOnly;
end;

procedure TRxCustomDBComboBox.DataChange(Sender: TObject);
begin
...
procedure TRxCustomDBComboBox.UpdateData(Sender: TObject);
begin
...
procedure TRxCustomDBComboBox.SetComboText(const Value: string);
var
  I: Integer;
  Redraw: Boolean;
begin
...
procedure TRxCustomDBComboBox.CMGetDataLink(var Message: TLMessage);
begin
  Message.Result := PtrUInt(FDataLink);
end;

function TRxCustomDBComboBox.GetComboText: string;
var
  I: Integer;
begin
...
procedure TRxCustomDBComboBox.Change;
begin
  FDataLink.Edit;
  FDataLink.Modified;
...
procedure TRxCustomDBComboBox.Click;
begin
  FDataLink.Edit;
  inherited Click;
  FDataLink.Modified;
...
procedure TRxCustomDBComboBox.DropDown;
begin
  FDataLink.Edit;
  inherited DropDown;
end;

function TRxCustomDBComboBox.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TRxCustomDBComboBox.SetDataSource(Value: TDataSource);
begin
...
function TRxCustomDBComboBox.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TRxCustomDBComboBox.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;

function TRxCustomDBComboBox.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

procedure TRxCustomDBComboBox.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

function TRxCustomDBComboBox.GetField: TField;
begin
  Result := FDataLink.Field;
end;

procedure TRxCustomDBComboBox.KeyDown(var Key: Word; Shift: TShiftState);
begin
...
procedure TRxCustomDBComboBox.KeyPress(var Key: Char);
begin
...
procedure TRxCustomDBComboBox.EditingChange(Sender: TObject);
begin
  SetEditReadOnly;
end;

procedure TRxCustomDBComboBox.SetEditReadOnly;
begin
...
procedure TRxCustomDBComboBox.WndProc(var Message: TLMessage);
begin
...
procedure TRxCustomDBComboBox.EditingDone;
begin
...
function TRxCustomDBComboBox.GetPaintText: string;
begin
  if FDataLink.Field <> nil then Result := FDataLink.Field.Text
  else Result := '';
end;

procedure TRxCustomDBComboBox.SetItems(const Value: TStrings);
begin
  Items.Assign(Value);
  DataChange(Self);
end;

procedure TRxCustomDBComboBox.SetStyle(Value: TComboBoxStyle);
begin
...
function TRxCustomDBComboBox.UseRightToLeftAlignment: Boolean;
begin
//  Result := DBUseRightToLeftAlignment(Self, Field);
end;

function TRxCustomDBComboBox.ExecuteAction(AAction: TBasicAction): Boolean;
begin
{  Result := inherited ExecuteAction(AAction) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(AAction);}
end;

function TRxCustomDBComboBox.UpdateAction(AAction: TBasicAction): Boolean;
begin
